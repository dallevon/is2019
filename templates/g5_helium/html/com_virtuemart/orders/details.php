...
<div class="vm-wrap">
    <div class="vm-orders-information">
        ...
        <div>
            <a href="<?php echo $this->order_list_link ?>" id="order_list_link" class="button button-bevel button-small button-outline" rel="nofollow"><?php echo vmText::_('COM_VIRTUEMART_ORDERS_VIEW_DEFAULT_TITLE'); ?></a>
        </div>
        <?php 
      } ?>
        <div class="vm-orders-order">
            <?php
            echo $this->loadTemplate('order');
            ?>
        </div>

        <div class="is-vm-orders-items">
            <?php

...
if ($this->order) {
  ?>
<div class="anonymous-order-section">
    ...
    <div class="order-connect">
        ...
        <form id="com-form-login" action="<?php echo JUri::root(true) . '/' . $url; ?>" method="post" name="com-login" class="well">
            <fieldset class="userdata">
                <div id="com-form-login-username">
                    <input type="text" name="username" class="inputbox" size="18" title="<?php echo vmText::_('COM_USERS_LOGIN_USERNAME_LABEL'); ?>" value="<?php echo vmText::_('COM_USERS_LOGIN_USERNAME_LABEL'); ?>" onblur="if(this.value=='') this.value='<?php echo addslashes(vmText::_('COM_USERS_LOGIN_USERNAME_LABEL')); ?>';" onfocus="if(this.value=='<?php echo addslashes(vmText::_('COM_USERS_LOGIN_USERNAME_LABEL')); ?>') this.value='';" />
                </div>
...
<?php 
  // end of anonymous order section
} else if ($user->id) { ?>
